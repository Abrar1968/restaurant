...
@section('title', 'Add Track Record')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-bold text-white">Add Track Record</h1>
        </div>
    </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.track-records.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="bg-[#111] border border-white/10 rounded-lg p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="year" id="year" value="{{ old('year', date('Y')) }}" min="2000" max="2030" required
                           class="bg-[#1A1A1A] border border-white/10 rounded px-4 py-2.5 text-white focus:border-[#C9A84C] focus:ring-1 focus:ring-[#C9A84C] outline-none w-full">
                </div>
            ...
            <div x-data="{ preview: null }">
                ...
                <template x-if="preview">
                    <img :src="preview" class="mt-3 w-48 h-32 object-cover rounded border border-white/10" alt="Preview">
                </template>
            </div>
        </div>
