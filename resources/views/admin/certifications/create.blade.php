...
<div class="space-y-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Add Certification</h1>
            <p class="text-gray-400 mt-1">Add a new certification or accreditation</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.certifications.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-[#111] border border-white/10 rounded-lg p-6 space-y-6">
            ...
            <div x-data="{ preview: null }">
                <label for="image" class="block text-sm font-medium text-gray-300 mb-1.5">Certificate Image</label>
