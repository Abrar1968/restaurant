...
<div class="space-y-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Add Gallery Category</h1>
            <p class="text-gray-400 mt-1">Create a new gallery category</p>
        </div>
    </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.gallery-categories.store') }}" method="POST" x-data="{
        name: '{{ old('name') }}',
        slug: '{{ old('slug') }}',
        autoSlug: true,
        generateSlug(name) {
