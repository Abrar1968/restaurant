        ...
        <div class="bg-[#111] border border-white/10 rounded-lg p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="bio" id="bio" rows="4"
                          class="bg-[#1A1A1A] border border-white/10 rounded px-4 py-2.5 text-white focus:border-[#C9A84C] focus:ring-1 focus:ring-[#C9A84C] outline-none w-full"
                          placeholder="Brief biography...">{{ old('bio', $member->bio) }}</textarea>
            </div>
            ...
            <div x-data="{ preview: null }">
                ...
                @if($member->photo)
                    <div class="mb-3 flex justify-center">
                        <div>
                            <p class="text-xs text-gray-400 mb-2 text-center">Current photo:</p>
                ...
                <template x-if="preview">
                    <div class="mt-3 flex justify-center">
                        <img :src="preview" class="w-24 h-24 rounded-full object-cover border-2 border-white/10" alt="New preview">
                    </div>
                </template>
            </div>
        </div>
